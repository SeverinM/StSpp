...
import StSpp.util.IDCheckDontTouchPls;
import StSpp.util.TextureLoader;
import StSpp.variables.DefaultCustomVariable;
        ...
        EditCharactersSubscriber
{
    ...
    public static final Logger logger = LogManager.getLogger("StSpp");
    ...
    private static final String MODNAME = "StS++";
    private static final String AUTHOR = "Bata";
    private static final String DESCRIPTION = "Simple vanilla extensions , no new mechanics or character";
    ...
    private static final String ATTACK_DEFAULT_GRAY = "StSppResources/images/512/bg_attack_default_gray.png";
    private static final String SKILL_DEFAULT_GRAY = "StSppResources/images/512/bg_skill_default_gray.png";
    private static final String POWER_DEFAULT_GRAY = "StSppResources/images/512/bg_power_default_gray.png";
    
    private static final String ENERGY_ORB_DEFAULT_GRAY = "StSppResources/images/512/card_default_gray_orb.png";
    private static final String CARD_ENERGY_ORB = "StSppResources/images/512/card_small_orb.png";
    
    private static final String ATTACK_DEFAULT_GRAY_PORTRAIT = "StSppResources/images/1024/bg_attack_default_gray.png";
    private static final String SKILL_DEFAULT_GRAY_PORTRAIT = "StSppResources/images/1024/bg_skill_default_gray.png";
    private static final String POWER_DEFAULT_GRAY_PORTRAIT = "StSppResources/images/1024/bg_power_default_gray.png";
    private static final String ENERGY_ORB_DEFAULT_GRAY_PORTRAIT = "StSppResources/images/1024/card_default_gray_orb.png";
    
    // Character assets
    private static final String THE_DEFAULT_BUTTON = "StSppResources/images/charSelect/DefaultCharacterButton.png";
    private static final String THE_DEFAULT_PORTRAIT = "StSppResources/images/charSelect/DefaultCharacterPortraitBG.png";
    public static final String THE_DEFAULT_SHOULDER_1 = "StSppResources/images/char/defaultCharacter/shoulder.png";
    public static final String THE_DEFAULT_SHOULDER_2 = "StSppResources/images/char/defaultCharacter/shoulder2.png";
    public static final String THE_DEFAULT_CORPSE = "StSppResources/images/char/defaultCharacter/corpse.png";
    
    //Mod Badge - A small icon that appears in the mod settings menu next to your mod.
    public static final String BADGE_IMAGE = "StSppResources/images/Badge.png";
    
    // Atlas and JSON files for the Animations
    public static final String THE_DEFAULT_SKELETON_ATLAS = "StSppResources/images/char/defaultCharacter/skeleton.atlas";
    public static final String THE_DEFAULT_SKELETON_JSON = "StSppResources/images/char/defaultCharacter/skeleton.json";
    ...
    public void receiveEditPotions() {
        ...
        BaseMod.addPotion(InhibitionPotion.class, CardHelper.getColor(58,5,102), CardHelper.getColor(58,5,102), CardHelper.getColor(58,5,102), InhibitionPotion.POTION_ID);
    ...
    public void receiveEditRelics() {
        ...
        BaseMod.addRelic(new PetrifiedCaterpillar(), RelicType.SHARED);
        BaseMod.addRelic(new JackpotMachine(), RelicType.SHARED);
        //BaseMod.addRelic(new SpiranhaBones(), RelicType.RED);
        BaseMod.addRelic(new ChessPiece(), RelicType.GREEN);
        BaseMod.addRelic(new BackupBattery(), RelicType.BLUE);
        BaseMod.addRelic(new PileOfSugar(), RelicType.SHARED);
        BaseMod.addRelic(new GiftCard(), RelicType.SHARED);
        BaseMod.addRelic(new CrystalBall(), RelicType.SHARED);
        BaseMod.addRelic(new WoodenPendulum(), RelicType.SHARED);
        BaseMod.addRelic(new WoodenStick(), RelicType.SHARED);
        ...
        UnlockTracker.markRelicAsSeen(BoiledEgg.ID);
        UnlockTracker.markRelicAsSeen(BrokenTotem.ID);
        UnlockTracker.markRelicAsSeen(SailingBoat.ID);
        UnlockTracker.markRelicAsSeen(SailorCap.ID);
        UnlockTracker.markRelicAsSeen(TwinEgg.ID);
        UnlockTracker.markRelicAsSeen(PetrifiedCaterpillar.ID);
        UnlockTracker.markRelicAsSeen(JackpotMachine.ID);
        UnlockTracker.markRelicAsSeen(ChessPiece.ID);
        UnlockTracker.markRelicAsSeen(PileOfSugar.ID);
        UnlockTracker.markRelicAsSeen(GiftCard.ID);
        UnlockTracker.markRelicAsSeen(BackupBattery.ID);
        //UnlockTracker.markRelicAsSeen(SpiranhaBones.ID);
        UnlockTracker.markRelicAsSeen(CrystalBall.ID);
        UnlockTracker.markRelicAsSeen(WoodenPendulum.ID);
        UnlockTracker.markRelicAsSeen(WoodenStick.ID);
    ...
    public void receiveEditCards() {
        ...
        new AutoAdd("StSpp") //${project.artifactId}
            .packageFilter(Sprint.class)
            .setDefaultSeen(true)
            .cards();
        ...
        switch (Settings.language)
        {
            case FRA:
            {
                ...
                BaseMod.loadCustomStringsFile(OrbStrings.class,
                        getModID() + "Resources/localization/fr/DefaultMod-Orb-Strings.json");
                ...
                BaseMod.loadCustomStringsFile(CardStrings.class,
                        getModID() + "Resources/localization/fr/DefaultMod-Card-Strings.json");

                // PowerStrings
                BaseMod.loadCustomStringsFile(PowerStrings.class,
                        getModID() + "Resources/localization/fr/DefaultMod-Power-Strings.json");

                // RelicStrings
                BaseMod.loadCustomStringsFile(RelicStrings.class,
                        getModID() + "Resources/localization/fr/DefaultMod-Relic-Strings.json");

                // Event Strings
                BaseMod.loadCustomStringsFile(EventStrings.class,
                        getModID() + "Resources/localization/fr/DefaultMod-Event-Strings.json");

                // PotionStrings
                BaseMod.loadCustomStringsFile(PotionStrings.class,
                        getModID() + "Resources/localization/fr/DefaultMod-Potion-Strings.json");

                // CharacterStrings
                BaseMod.loadCustomStringsFile(CharacterStrings.class,
                        getModID() + "Resources/localization/fr/DefaultMod-Character-Strings.json");
