...
public class VitalPointPower extends AbstractPower
{
    public static final String POWER_ID = DefaultMod.makeID("VitalPointPower");
    ...
    public VitalPointPower(int amount)
    {
        name = NAME;
        ID = POWER_ID;
